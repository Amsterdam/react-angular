...
var AngularWrapper = function (_Component) {
  ...
  function AngularWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AngularWrapper.__proto__ || Object.getPrototypeOf(AngularWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      angularActive: false
    }, _this.component = null, _this.buildAngularComponent = function () {
      ...
      _this.component = (0, _react.createElement)((0, _camelCaseToDash2.default)(component), angularAttributes);
    }, _this.setAngularApp = function (angularApp) {
      if (angularApp) {
        _this.angularApp = angularApp;
      }
    }, _this.setComponent = function (component) {
      if (component) {
        _this.angularComponent = component;
        _this.$rootScope = _this.angularComponent.$scope.$root;
      }
