...
var AngularWrapper = function (_Component) {
  ...
  _createClass(AngularWrapper, [{
    ...
    value: function componentDidMount() {
      ...
      angularInstance.module(moduleName, [].concat(_toConsumableArray(dependencies), [(0, _angularTemplate.reactAngularModule)(angularInstance, false).name])).directive('exposeScope', function () {
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          angularInstance = _props3.angularInstance;
...
AngularWrapper.propTypes = {
  ...
  angularInstance: _propTypes2.default.any
};
