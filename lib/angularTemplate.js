...
function reactAngularModule(angularInstance) {
  var usesNgReact = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

  var raModule = angularInstance.module('react-angular', usesNgReact ? ['react'] : []).config(['$compileProvider', function ($compileProvider) {
  ...
  _createClass(ReactAngular, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          ...
          angularInstance = _props.angularInstance;
      ...
      var actualTemplate = angularInstance.isFunction(actualTemplateFunc) ? actualTemplateFunc(inject) : actualTemplateFunc;
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          angularInstance = _props2.angularInstance;

      var ref = function ref(element) {
        return _this2.$element = angularInstance.element(element);
      };
