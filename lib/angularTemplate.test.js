...
describe('AngularTemplate', function () {
  ...
  var compile = function compile(Component) {
    ...
    var element = $compile('<react-angularComponent name="Component" props="props"></react-angularComponent>')($rootScope, function (clone) {
  ...
  it('can embed angularComponent directives as JSX with className', function () {
    var element = compile(function () {
      return _react2.default.createElement(
        _angularTemplate2.default,
        { className: 'plop' },
  ...
  it('passes the scope in ngReact custom directives', function () {
    ...
    var $element = $compile('<ng-react-directive toto="propsToPass.toto" angularComponent="Component" />')($rootScope, function (clone) {
      $container.append(clone);
    });
    $rootScope.$digest();
